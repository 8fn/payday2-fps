...
if Network:is_server() then
	...
	local fs_original_elementareatrigger_clientcheckstate = ElementAreaTrigger._client_check_state
	function ElementAreaTrigger:_client_check_state(...)
		if managers.network:session() then
			fs_original_elementareatrigger_clientcheckstate(self, ...)
		end
	end

	local fs_original_elementareareporttrigger_clientcheckstate = ElementAreaReportTrigger._client_check_state
	function ElementAreaReportTrigger:_client_check_state(...)
		if managers.network:session() then
			fs_original_elementareareporttrigger_clientcheckstate(self, ...)
		end
	end
end
